...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-blue-700 to-blue-900 text-gray-100">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div>
        ...
        <p className="text-gray-200 text-sm mt-4 mb-6">
          We offer the fastest bonding agent available on the market, designed
          to save you time and money while enabling you to achieve superior
