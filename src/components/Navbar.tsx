...
import { Search, ShoppingCart, User, Menu, X, LogOut, ChevronDown, Sun, Moon } from 'lucide-react';
            ...
            {isAuthenticated ? (
              <div className="relative group">
                <button className="flex items-center space-x-2 p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full transition-colors duration-200">
                  ...
                  <span className="text-sm hidden md:block text-gray-700 dark:text-gray-300">{user?.name}</span>
              ...
              >
                <User className="h-6 w-6 text-gray-700 dark:text-gray-300" />
                <span className="hidden md:block text-gray-700 dark:text-gray-300">Sign in</span>
              </Link>
            )}
